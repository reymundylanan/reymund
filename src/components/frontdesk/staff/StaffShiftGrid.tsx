import { staffShifts } from "@/lib/frontdeskData";
import type { ShiftBlock } from "@/lib/frontdeskData";

const START_HOUR = 9;
const END_HOUR = 20.5;
const COL_WIDTH = 64;

const blockStyles: Record<ShiftBlock["type"], string> = {
  working: "border-l-4 border-coral bg-blush text-ink",
  break: "border-l-4 border-ink/30 bg-ink/5 text-ink/50",
  off: "border-l-4 border-red-300 bg-red-50 text-red-500",
};
